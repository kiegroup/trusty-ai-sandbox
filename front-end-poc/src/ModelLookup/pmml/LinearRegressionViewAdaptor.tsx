...
const LinearRegressionViewAdaptor = (props: Props) => {
  ...
  const numbericPredictor: PMML.NumericPredictorType | undefined = getNumericPredictorType(table);
...
function getRegressionTable(model: PMML.RegressionModelType): PMML.RegressionTableType | undefined {
...
function getNumericPredictorType(table: PMML.RegressionTableType): PMML.NumericPredictorType | undefined {
...
function getLines(table: PMML.RegressionTableType, numbericPredictor: PMML.NumericPredictorType): Line[] {
...
function getYRange(props: Props, model: PMML.RegressionModelType): Range | undefined {
  const targetField: PMML.MiningFieldType | undefined = getTargetMiningField(model);
  if (targetField === undefined) {
    return undefined;
  }
  const targetFieldIntervals: PMML.IntervalType[] | undefined = getMiningFieldIntervals(props, targetField.name);
...
function getXRange(props: Props, numbericPredictor: PMML.NumericPredictorType): Range | undefined {
  const predictorFieldIntervals: PMML.IntervalType[] | undefined = getMiningFieldIntervals(props, numbericPredictor.name);
...
function getIntervalsMaximumRange(intervals: PMML.IntervalType[] | undefined): Range | undefined {
  if (intervals === undefined) {
    return undefined;
  }
