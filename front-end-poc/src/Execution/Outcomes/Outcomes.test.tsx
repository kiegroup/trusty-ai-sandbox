  ...
  outcomes: [
    {
      ...
      outcomeResult: {
        ...
        components: [
          [
            { name: "Product", value: "Lender B - ARM5/1-Standard", typeRef: "string", components: [] },
            { name: "Recommendation", value: "Good", typeRef: "string", components: [] },
            { name: "Note Amount", value: "$273,775.90", typeRef: "string", components: [] },
            { name: "Interest Rate", value: "3.8", typeRef: "string", components: [] },
            { name: "Monthly Payment", value: "$1,267.90", typeRef: "string", components: [] },
            { name: "Cash to Close", value: "$1,267.90", typeRef: "string", components: [] },
            { name: "Required Credit Score", value: 720, typeRef: "number", components: [] },
          ],
          [
            { name: "Product", value: "Lender C - Fixed30-Standard", typeRef: "string", components: [] },
            { name: "Recommendation", value: "Best", typeRef: "string", components: [] },
            { name: "Note Amount", value: "$274,599.40", typeRef: "string", components: [] },
            { name: "Interest Rate", value: "3.88", typeRef: "string", components: [] },
            { name: "Monthly Payment", value: "$1,291.27", typeRef: "string", components: [] },
            { name: "Cash to Close", value: "$75,491.99", typeRef: "string", components: [] },
            { name: "Required Credit Score", value: 680, typeRef: "number", components: [] },
          ],
        ],
      },
    },
        ...
        components: [
          {
            ...
            typeRef: "string",
            components: [
              { name: "Loan Amount", value: 540000, typeRef: "number", components: [] },
              { name: "Repayment Rate", value: 900, typeRef: "number", components: [] },
              { name: "Loan Eligibility", value: true, typeRef: "boolean", components: [] },
            ],
          },
          {
            name: "Rating Type B",
            ...
            typeRef: "number",
            components: [
              { name: "Loan amount", value: 340000, typeRef: "number", components: [] },
              { name: "Repayment rate", value: 2000, typeRef: "number", components: [] },
              {
                name: "Sub-Rating Type C",
                value: null,
                typeRef: "number",
                components: [
                  { name: "Loan amount", value: 390000, typeRef: "number", components: [] },
                  { name: "Repayment rate", value: 5000, typeRef: "number", components: [] },
                ],
              },
            ],
          },
  ...
  outcomes: [
    {
      ...
      outcomeResult: {
        ...
        value: null,
        components: [
          { name: "Auth Code", typeRef: "tAuthCode", value: "Authorized", components: [] },
