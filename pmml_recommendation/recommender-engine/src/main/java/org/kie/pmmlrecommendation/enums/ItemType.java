...
public enum ItemType {
    ...
    public static ItemType byClusterId(int clusterId) {
        return Arrays.stream(ItemType.values())
                ...
                .findFirst()
                .orElseThrow(() -> new KieEnumException("Failed to find ItemType with clusterId: " + clusterId));
    }
    ...
    public static ItemType byClusterName(String clusterName) {
        return Arrays.stream(ItemType.values())
                ...
                .findFirst()
                .orElseThrow(() -> new KieEnumException("Failed to find ItemType with clusterName: " + clusterName));
    }
