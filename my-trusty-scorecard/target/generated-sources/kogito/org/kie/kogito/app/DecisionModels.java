...
public class DecisionModels implements org.kie.kogito.decision.DecisionModels {
    ...
    private final static org.kie.dmn.api.core.DMNRuntime dmnRuntime = org.kie.kogito.dmn.DMNKogito.createGenericDMNRuntime(kieRuntimeFactoryFunction, readResource(org.drools.core.util.IoUtils.class.getClassLoader().getResourceAsStream("employeeScore.dmn")));

    private final static org.kie.kogito.ExecutionIdSupplier execIdSupplier = new org.kie.kogito.dmn.DmnExecutionIdSupplier();
